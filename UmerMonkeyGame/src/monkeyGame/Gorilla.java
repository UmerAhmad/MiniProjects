...
/** Gorilla class to store all getters and setters. */
public class Gorilla {    
    ...
    // Global string left (to determine if the user input A).*/
    String left = "A";
    // Global string right (to determine if the user input D).*/
    String right = "D";
    // Global string up (to determine if the user input W).*/
    String up = "W";
    // Global string down (to determine if the user input S).*/
    String down = "S";
    
    
    // Global String of image name (to insert into image). */
    String imageName = "images/gorilla.gif";
    ...
    /** Gorilla constructor that initializes canvas and graphics context without an image name
	 ...
	 */
    public Gorilla(GraphicsContext gc, Canvas canvas) {
        super();
        this.gc = gc;
	 ...
	 */
    public Gorilla(String imageName, GraphicsContext gc, Canvas canvas) {
        super();
    ...
    /** Gets the speed value of the Gorilla.
    ...
    /** Sets the speed value of the Gorilla to the parametered integer.
    ...
    /** Gets the X value of the Gorilla.
    ...
    /** Gets the Y value of the Gorilla.
    ...
    /** Gets the dx value of the Gorilla.
    ...
    /** Sets the dx value of the Gorilla.
    ...
    /** Gets the dy value of the Gorilla.
    ...
    /** Sets the dy value of the Gorilla.
    ...
    /** Gets the image name of the Gorilla.
	 * @return A string representing the file of reference to the image of the Gorilla.
	 */
    public String getImageName() {
        return imageName;
    }

    /** Sets the image name of the Gorilla to the parameterd string.
	 * @param imageName A string representing the file of reference to the image of the Gorilla.
	 */
    ...
    /** Gets the width of the Gorilla image.
	 * @return A double representing the Gorilla image width.
	 */
    public double getWidth() {
        return image.getWidth();
    }
    
    /** Gets the height of the Gorilla image.
	 * @return A double representing the Gorilla image height.
	 */
    public double getHeight() {
        return image.getHeight();
    }
    
    /** Gets the total x traveled value of the Gorilla.
    ...
    /** Sets the total x traveled value of the Gorilla.
    ...
    /** Gets the total y traveled value of the Gorilla.
    ...
    /** Sets the total y traveled value of the Gorilla.
    ...
    /** Gets the total distanced traveled value of the Gorilla.
    ...
    /** Method to update x and y position of gorilla, and display onto screen based off WASD input.
	 * @param input An arraylist of strings that contain user input, depending on the input the gorilla will move.
	 */
